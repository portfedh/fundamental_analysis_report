...
for ticker in imported_list:
    ...
    table_bs_df.drop(['WA ShsOut', 'WA ShsOutDil', 'Revenue', 'Gross Profit',
                      'R&D Expenses', 'Op Expenses', 'Op Income', 'Net Income',
                      'EPS', 'CF Operations', 'CF Investing', 'CF Financing',
                      'CAPEX', 'FCF',  'Cash', 'Dividends Paid',
